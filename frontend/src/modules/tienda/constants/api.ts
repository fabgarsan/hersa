export const TIENDA_API = {
  PRODUCTOS: "/api/v1/tienda/productos/",
  PROVEEDORES: "/api/v1/tienda/proveedores/",
  STOCK: "/api/v1/tienda/stock/",
  STOCK_TOTAL: "/api/v1/tienda/stock/total/",
  STOCK_REABASTECIMIENTO: "/api/v1/tienda/stock/reabastecimiento/",
  ORDENES: "/api/v1/tienda/ordenes-compra/",
